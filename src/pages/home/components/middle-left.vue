  ...
  methods: {
    ...
    showInTab() {
      ...
      let param = {
        ...
        tabName: '变压器结果对比表（整点）',
        url: `${window.eagle2HummerRootPath}/hummer/report.action?queryId=4028801b5d0cacfe015d0d8c14360000&COMPANY_ID=${COMPANY_ID}&BEGIN_DATA_TIME=${DATA_TIME} 00:00&END_DATA_TIME=${DATA_TIME} 23:59`,
        isRefresh: true
      }
